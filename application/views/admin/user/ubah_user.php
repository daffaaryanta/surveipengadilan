        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('con_user/proses_ubah/' . $user->id_user) ?>" id="form-tambah" method="POST">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <input type="hidden" name="id_user" placeholder="id_user" autocomplete="off" class="form-control" required value="<?= $user->id_user ?>">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="nama_user"><strong>Nama</strong></label>
                                    <input type="text" name="nama_user" placeholder="Masukkan Nama" autocomplete="off" class="form-control" required value="<?= $user->nama_user ?>">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="id_role"><strong>Role</strong></label>
                                    <select name="id_role" id="id_role" class="form-control" required>
                                        <option value="">-- Silahkan Pilih --</option>
                                        <option value="1" <?= $user->id_role == '1' ? 'selected' : '' ?>>Pimpinan</option>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="username" placeholder="Masukkan username" autocomplete="off" class="form-control" required value="<?= $user->username ?>">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="password"><strong>Password</strong></label>
                                    <input type="password" name="" placeholder="Masukkan Password Baru" autocomplete="off" class="form-control" required value="<?= $user->password ?>">
                                </div>
                            </div>
                            <div class=" form-row">
                                <div class="form-group col-md-6">
                                    <label for="date_created"><strong>Waktu Registrasi</strong></label>
                                    <input type="text" name="date_created" id="date_created" class="form-control" value="<?= $user->date_created ?>" required readonly>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <button type="reset" class="btn"><a href="<?= base_url('con_user') ?>" class="btn btn-danger"><i class="fa fa-times"></i>&nbsp;&nbsp;Batal</a></button>
                            </div>
                    </div>
                </div>
