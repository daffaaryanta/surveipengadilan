        ...
        <div class="container-fluid">
          ...
          <div class="float-right">
            ...
            <form method="post">
              ...
              <a href="<?php echo base_url() ?>cetak/cetak_hukum" target="_blank" class="btn btn-success mb-2"><i class="fa fa-file-pdf"></i>&nbsp;&nbsp;Cetak</a>
            </form>
          </div>
          <br><br><br>
          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-dark">Pelayanan Hukum</h6>
            </div>
            <div class="card-body">
