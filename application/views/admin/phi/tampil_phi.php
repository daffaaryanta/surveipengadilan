        ...
        <div class="container-fluid">
          ...
          <div class="float-right">
            ...
            <form method="post">
              ...
              <a href="<?php echo base_url() ?>cetak/cetak_phi" target="_blank" class="btn btn-success mb-2"><i class="fa fa-file-pdf"></i> Cetak</a>
            </form>
          </div>
          <br /><br><br>
          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-dark">Pelayanan PHI</h6>
            </div>
            <div class="card-body">
                  ...
                  <tbody>
                    <?php foreach ($all_phi as $phi) : ?>
                      <tr>
                        ...
                        <td><?= date('d-m-Y H:i:s', strtotime($phi->waktu_input)); ?></td>
                        <td>
                          <a href="<?= base_url('con_phi/ubah/' . $phi->id_responden) ?>" class="btn btn-success btn-sm"><i class="fa fa-pen"></i></a><br>
                          <a onclick="return confirm('apakah anda yakin?')" href="<?= base_url('con_phi/hapus/' . $phi->id_responden) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                        </td>
                      </tr>
                    <?php endforeach ?>
                  </tbody>
