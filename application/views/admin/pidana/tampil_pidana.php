        ...
        <div class="container-fluid">
          ...
          <div class="float-right">
            ...
            <form method="post">
              ...
              <a href="<?php echo base_url() ?>cetak/cetak_pidana" target="_blank" class="btn btn-success mb-2"><i class="fa fa-file-pdf"></i> Cetak</a>
            </form>
          </div>
          <br /><br><br>
          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-dark">Pelayanan Pidana</h6>
            </div>
            <div class="card-body">
                  ...
                  <tbody>
                    <?php foreach ($all_pidana as $pidana) : ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?= base_url('con_pidana/ubah/' . $pidana->id_responden) ?>" class="btn btn-success btn-sm"><i class="fa fa-pen"></i></a><br>
                          <a onclick="return confirm('apakah anda yakin?')" href="<?= base_url('con_pidana/hapus/' . $pidana->id_responden) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                        </td>
                      </tr>
                    <?php endforeach ?>
                  </tbody>
